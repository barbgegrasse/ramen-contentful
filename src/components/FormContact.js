...
class FormContact extends React.Component {
    ...
    handleChange(event) {
        ...
        if( document.getElementById('message').value.trim() && document.getElementById('pseudo').value.trim()){
    ...
    render() {
        return (
            <form onSubmit={this.handleSubmit} className="form-comment" action="/thankyou" name={this.props.formName} method="POST"  netlify-honeypot="bot-field" data-netlify="true">
                <input className="" type="hidden" name="form-name" value={this.props.formName} />
                <p class="d-none">
                    <label>Pour mes amis les robots : <input name="bot-field" /></label>
                </p>

                <div className="block-item-form">
                    <input id="pseudo" value={this.state.formControls.pseudo.value} onChange={this.handleChange} className="item-form item-input" name="pseudo" required type="text" onChange={this.handleChange} />
                ...
                <div className="block-item-form">
                    <textarea id="message" onBlur={this.handleBlur} onFocus={this.handleFocus} onChange={this.handleChange} className="item-form item-textarea" name="message" required></textarea>
                    <label className="label-name">
                ...
                <div className="sad hide" id="sad">(⌯˃̶᷄ ﹏ ˂̶᷄⌯)ﾟ</div>
            </form>
        );
    }
}
